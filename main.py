...
def get_answer(context, question):
    ...
    # try:
    res = client.text_generation(f"Use the following pieces of context to answer the user's question, Context is :{context} and User's question is:{question}.", max_new_tokens=250)
